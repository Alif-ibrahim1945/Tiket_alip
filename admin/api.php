...
if (empty($mallId) || empty($filmId) || empty($tanggalTayang) ||
...
VALUES (?, ?, ?, ?, ?, ?, ?, ?,?)";
$stmt = mysqli_prepare($conn, $query);
mysqli_stmt_bind_param($stmt, "iisssssss", $mallId, 
$filmId,$studio,$jam1,$jam2,$jam3, $tanggalTayang, $tanggalAkhirTayang, 
$totalMenit);
