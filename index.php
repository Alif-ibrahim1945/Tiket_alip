...
<body class="animsition">
	...
	$showUsername = false; // Tidak menampilkan nama user di index.php
	?>
			...
			<div class="wrap-slick1">
				<div class="slick1">
					<?php while ($row = $result->fetch_assoc()) { ?>
						<div class="item-slick1" style="background-image: url('<?php echo htmlspecialchars($row['banner']); ?>');">
						</div>
					<?php } ?>
				</div>
			</div>
	...
	<section class="bg0 p-t-23 p-b-140" style="padding-top: 40px;">
		<div class="container">
			<div class="p-b-10">
						...
						<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item">
							<div class="block2">
								<div class="block2-pic hov-img0">
									<img src="<?php echo htmlspecialchars($row['poster']); ?>" alt="Poster" width="100" height="300">
   ...
   Quick View
								...
								<div class="block2-txt p-t-20 p-b-20 text-center"> <!-- Jarak lebih besar di sini -->
							...
							if ($row['usia'] == 13) {
								...
								echo 'gray'; // Default warna jika tidak ada yang cocok
							}
				...
				<?php
					...
					echo "<p class='text-center'>Tidak ada film yang tersedia.</p>";
				}
				?>
			</div>
		</div>
